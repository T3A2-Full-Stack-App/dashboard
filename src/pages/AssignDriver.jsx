      ...
      <>
        <div className="flex gap-10 flex-wrap justify-center">
          ...
          >
            ...
            <form
              onSubmit={(e) =>
                pairDriverVehicle(e, thisDriverData, thisVehicleData)
              }
            >
              <select
                required
              ...
              <button
                className="h-8 px-14  mt-8 text-sm bg-blue-500 hover:bg-blue-700 text-white transition-colors duration-15 rounded-lg focus:shadow-outline"
                type="submit"
              >
                Save
              </button>
            </form>
            <div className="flex justify-end tracking-wide font-normal text-base  content-around">
              <Link
                to="/drivers"
                className="mr-2 flex justify-end font-medium file:mt-2 text-blue-500 hover:text-blue-700 "
              >
              ...
              <Link
                to="/vehicles"
                className="ml-2 flex justify-end font-medium file:mt-2 text-blue-500 hover:text-blue-700 "
              >
                {" "}
