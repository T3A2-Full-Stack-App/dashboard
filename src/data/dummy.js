...
export const EditorData = () => (
  <div>
    <h3>
      The purpose of this full-stack application is to provide an efficient and
      well-designed fleet management dashboard application for internal use by
      transport businesses to manage their vehicles, drivers and task
      allocation. After speaking with a local courier business and assessing
      what problems they face, we found that the most important aspects we could
      assist with were the ability to manage their fleet and keep track of
      aspects such as driver to vehicle allocation, route allocation, vehicle
      kilometres, and vehicle service/maintenance tracking. With this
      information, we have worked to deliver a dashboard-style application that
      displays all of the required information in elegantly designed cards,
      graphs, charts and calendars. The purpose of the dashboard-style is to
      maintain a strong UX/UI design and provide all of the required information
      in one place to increase user productivity and ease of use.
    </h3>
  </div>
);
...
export const scheduleData = [
  {
    Id: 2,
    Subject: "Fleet Management Conference",
    Location: "Online/Remote",
    StartTime: "2021-01-11T02:00:00.000Z",
    EndTime: "2021-01-11T03:30:00.000Z",
  ...
  {
    Id: 6,
    Subject: "Mercedes Sprinter Van Service",
    Location: "Mercedes Brisbane",
  ...
  },
  {
    ...
    Location: "Space Center AUS",
    StartTime: "2021-01-18T00:00:00.000Z",
    EndTime: "2021-01-18T01:00:00.000Z",
    CategoryColor: "#7fa900",
  },
  {
    Id: 10,
  ...
  },
  {
    ...
    Subject: "Pizza",
    Location: "Main Office",
    StartTime: "2021-01-21T01:00:00.000Z",
    EndTime: "2021-01-21T02:30:00.000Z",
  ...
  },
  {
    ...
    EndTime: "2021-01-11T01:00:00.000Z",
    CategoryColor: "#00bdae",
  },
  {
    Id: 19,
